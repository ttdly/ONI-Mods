...
namespace MoreTiles {
  public class AutoLightTileConfig : IBuildingConfig {
    ...
    public override BuildingDef CreateBuildingDef() {
      ...
      var none1 = NOISE_POLLUTION.NONE;
      var none2 = BUILDINGS.DECOR.NONE;
      var noise = none1;
      var buildingDef = BuildingTemplates.CreateBuildingDef(ID, 1, 1, "cellingLightTile_kanim", 100, 30f, tieR2,
        farmable, 1600f, BuildLocationRule.Tile, none2, noise);
