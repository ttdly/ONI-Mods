      ...
      public class PREFABS {
        public class AUTOLIGHTTILE {
          ...
          public static LocString DESC =
            " The tile will automatically detect whether there are duplicates working on the tile, and if so, they will light up for the duplicates.";
    ...
    public class GeneratedBuildings_LoadGeneratedBuildings_Patch {
      public static void Prefix() {
        ...
        Array NewBuildings = new Array[] {
          new[] { AutoLightTileConfig.ID, "Base", "InteriorDecor", "tiles" }
        };
