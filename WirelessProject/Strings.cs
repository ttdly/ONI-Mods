      ...
      public class PREFABS {
        public class POWERPROXY {
          ...
          public static LocString DESC =
            "WPT (Wireless Power Terminal) \n\n What? You mean it’s providing power for my entire base?";

          public static LocString EFFECT =
            "You can choose to connect the power consumption, generation, and batteries in the base to this terminal, which will then coordinate these devices.";
        }
      }
    }
