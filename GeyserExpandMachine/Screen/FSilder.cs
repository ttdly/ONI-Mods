...
public class FSlider : KMonoBehaviour, IEventSystemHandler, IDragHandler, IPointerDownHandler, IPointerClickHandler
	{
		...
		MapValue mapValue;
		FNumberInputField outputTarget;
		bool wholeNumbers;
		...
		public void AttachOutputField(FNumberInputField targetText)
		{
		...
		public void AttachInputField(FNumberInputField field, MapValue map = null)
		{
			mapValue = map;
			inputField = field;
			inputField.inputField.onEndEdit.AddListener(OnInputFieldChanged);
		}
		...
		private void SetOutputText()
		{
			...
			{
				outputTarget.inputField.text = slider.value.ToString(!wholeNumbers ? "0." + new string('0', TrailingOutputNumbers) : "0") + UnitString;
				// outputTarget.inputField.text = slider.value.ToString("0") + UnitString;
			}
		}
