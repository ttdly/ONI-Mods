...
public class GeyserC4Config : IBuildingConfig {
  ...
  public override BuildingDef CreateBuildingDef() {
    var tieR3_1 = BUILDINGS.CONSTRUCTION_MASS_KG.TIER5;
    string[] allMetals = { "Special" };
    var tieR3_2 = NOISE_POLLUTION.NOISY.TIER3;
    var tieR1 = BUILDINGS.DECOR.PENALTY.TIER1;
    var noise = tieR3_2;
    var buildingDef = BuildingTemplates.CreateBuildingDef("GeyserC4", 1, 2, "geyserc4_kanim", 30, 30f, tieR3_1,
      allMetals, 800f, BuildLocationRule.Anywhere, tieR1, noise);
  ...
  public override void ConfigureBuildingTemplate(GameObject go, Tag prefab_tag) {
    ...
    elementConverter.outputElements = new ElementConverter.OutputElement[2] {
      new ElementConverter.OutputElement(9.9f, SimHashes.Methane, 313.5f, outputElementOffsetx: 0f,
