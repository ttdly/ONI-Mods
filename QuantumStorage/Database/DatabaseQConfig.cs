...
namespace QuantumStorage.Database {
  public class DatabaseQConfig : IBuildingConfig {
    ...
    public override BuildingDef CreateBuildingDef() {
      ...
      var allMetals = MATERIALS.ALL_METALS;
      var tieR1 = NOISE_POLLUTION.NOISY.TIER1;
      var none = BUILDINGS.DECOR.NONE;
      var noise = tieR1;
      var buildingDef = BuildingTemplates.CreateBuildingDef(ID, 3, 3, "research_center2_kanim", 30, 30f, tieR4,
        allMetals, 1600f, BuildLocationRule.OnFloor, none, noise);
